            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <div style=" background-image: linear-gradient(white, rgba(255, 0, 0, 0.514)); padding: 20px; text-align: center;">
                        ...
                        <a href='/charts' style="color: blue;">Back</a><form action="/charts/{{$chartData->id}}" method="POST" style="display:inline">@csrf @method('DELETE')<button style="background-color: red; float: right; width: 8vw; height:2vw">Delete</button></form>
                        </div>
                    </div>
                </div>
